...
try {
    ...
    $stmt = $pdo->prepare("SELECT 
        i.id, i.type, i.description, i.location, i.latitude, i.longitude, i.media_path, i.status, 
        i.reported_at, i.resident_user_id,
        i.media_path AS image_path, 
        u.fullname AS reporter_name, u.email AS reporter_email, 
        r.contact_no AS reporter_contact, r.id AS resident_id
                           FROM incidents i
