...
try {
    ...
    $stmt = $pdo->prepare("SELECT id, 'document' AS request_type, document_type, status, payment_status, payment_date, or_number, reference_number, date_requested as requested_at, {$requestActivityExpr} AS activity_at
